...
public enum Permission {
    ...
    CAN_VIEW_IN_PROGRESS("CAN_VIEW_IN_PROGRESS", PermissionModel.PermissionType.SCHOOL, "View school deposits/retrieves in progress", null, true),
    CAN_VIEW_QUEUES("CAN_VIEW_QUEUES", PermissionModel.PermissionType.SCHOOL, "View school deposit/retrieval queues", null, true),
